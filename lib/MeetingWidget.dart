...
class MeetingWidget extends StatelessWidget {
  ...
  MeetingWidget({Key key, userId, meetingId, meetingPassword}) : super(key: key) {
    ...
    this.zoomOptions = new ZoomOptions(
      domain: "zoom.us",
      appKey: "dZmaH8cdeLAcLnT61opxd88IKWyZY17ZU2vE", // Replace with with key got from the Zoom Marketplace
      appSecret: "56kgafkjuwQW9odYdO6i2Uvn0DBdxBrfhpCq", // Replace with with secret got from the Zoom Marketplace
    );
